...
class _AffineGridGen(nn.Module):
...
class CylinderGridGen(nn.Module):
    def __init__(self, height, width, lr = 1, aux_loss = False):
...
class CylinderGridGenV2(nn.Module):
...
class DenseAffine3DGridGen(nn.Module):
    def __init__(self, height, width, lr = 1, aux_loss = False):
...
class DenseAffine3DGridGen_rotate(nn.Module):
    def __init__(self, height, width, lr = 1, aux_loss = False):
...
class Depth3DGridGen_with_mask(nn.Module):
